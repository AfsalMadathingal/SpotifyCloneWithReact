    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="bg-black text-white text-[15px]  py-1 px-3 rounded-2xl cursor-pointer ">
            Install App
          </p>
      ...
      <div className="flex items-center gap-2 mt-4 ">
        ...
        <p className="bg-black text-white px-4 py-1 rounded-2xl  cursor-pointer">Poscasts</p>
